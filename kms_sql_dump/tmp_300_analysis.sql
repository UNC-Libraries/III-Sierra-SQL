...
v.marc_tag = '300'
   and v.field_content !~* 'atlas|broadsides?|cards?|columns|pamphlets?|p\.|pages?|pagings?|plates?|portfolios?|[^o]prints?|ℓ\.|l\.|leaf|[lℓ]eaves|scores?|sheets?|v\.|vols?|volumes?'
